...
let waterColors = '/category/water.png'
...
<Carousel    showArrows autoPlay showThumbs={false}>
  ...
  {categories.map((z) => (
          ...
          :z==='צבעי מים'?(<div className='no-drop' onClick={(e) => scrollTop()}> <div className='animals'>  <img className='alt' src={waterColors} alt="Girl in a jacket" width="217"  height="180"></img> <h1 className='bot'>צבעי מים</h1></div></div>)
